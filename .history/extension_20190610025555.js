...
function fv_versioning(registered_command, root_item, semver_boss_command, step_value, bool_autosave) {
	...
	if (semver_boss_command == "getsettingshelp") {
		...
		var leading_chars_allowed_on_pattern_match_str = preg_replace("'(\s+)'sim", "", leading_chars_allowed_on_pattern_match_str);
		var leading_chars_allowed_on_pattern_match_ra = explode("", leading_chars_allowed_on_pattern_match_str);
